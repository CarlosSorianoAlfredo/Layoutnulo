...
btn_raizC.place(x=20, y=125, width=50, height=50)

btn_cuadrado = tk.Button(ventana_inicio, text="x^2", command=lambda: cuadrado())
btn_cuadrado.place(x=80, y=125, width=50, height=50)

btn_reciproco = tk.Button(ventana_inicio, text="1/x", command=lambda: reciproco())
btn_reciproco.place(x=140, y=125, width=50, height=50)

btn_por = tk.Button(ventana_inicio, text="%", command=lambda: porcentaje())
btn_por.place(x=200, y=125, width=50, height=50)

btn_c = tk.Button(ventana_inicio, text="C", command=lambda: limpiar_caja())
btn_c.place(x=20, y=65, width=110, height=50)

btn_delete = tk.Button(ventana_inicio, text="<-", command=lambda: clear())
btn_delete.place(x=140, y=65, width=50, height=50)

btn_div = tk.Button(ventana_inicio, text="/", command=lambda: realizar_operacion("/"))
btn_div.place(x=200, y=65, width=50, height=50)

btn_num_7 = tk.Button(ventana_inicio, text="7", command=lambda: mostrar_numero("7"))
btn_num_7.place(x=20, y=185, width=50, height=50)

btn_num_8 = tk.Button(ventana_inicio, text="8", command=lambda: mostrar_numero("8"))
btn_num_8.place(x=80, y=185, width=50, height=50)

btn_num_9 = tk.Button(ventana_inicio, text="9", command=lambda: mostrar_numero("9"))
btn_num_9.place(x=140, y=185, width=50, height=50)

btn_mult = tk.Button(ventana_inicio, text="X", command=lambda: realizar_operacion("*"))
btn_mult.place(x=200, y=185, width=50, height=50)

btn_num_4 = tk.Button(ventana_inicio, text="4", command=lambda: mostrar_numero("4"))
btn_num_4.place(x=20, y=240, width=50, height=50)

btn_num_5 = tk.Button(ventana_inicio, text="5", command=lambda: mostrar_numero("5"))
btn_num_5.place(x=80, y=240, width=50, height=50)

btn_num_6 = tk.Button(ventana_inicio, text="6", command=lambda: mostrar_numero("6"))
btn_num_6.place(x=140, y=240, width=50, height=50)

btn_menos = tk.Button(ventana_inicio, text="-", command=lambda: realizar_operacion("-"))
btn_menos.place(x=200, y=240, width=50, height=50)

btn_num_1 = tk.Button(ventana_inicio, text="1", command=lambda: mostrar_numero("1"))
btn_num_1.place(x=20, y=300, width=50, height=50)

btn_num_2 = tk.Button(ventana_inicio, text="2", command=lambda: mostrar_numero("2"))
btn_num_2.place(x=80, y=300, width=50, height=50)

btn_num_3 = tk.Button(ventana_inicio, text="3", command=lambda: mostrar_numero("3"))
btn_num_3.place(x=140, y=300, width=50, height=50)

btn_mas = tk.Button(ventana_inicio, text="+", command=lambda: realizar_operacion("+"))
btn_mas.place(x=200, y=300, width=50, height=50)

btn_num_0 = tk.Button(ventana_inicio, text="0", command=lambda: mostrar_numero("0"))
btn_num_0.place(x=80, y=360, width=50, height=50)

btn_punto = tk.Button(ventana_inicio, text=".", command=lambda: mostrar_numero("."))
btn_punto.place(x=140, y=360, width=50, height=50)

btn_mas_menos = tk.Button(ventana_inicio, text="-", command=lambda: mas_menos())
btn_mas_menos.place(x=20, y=360, width=50, height=50)
